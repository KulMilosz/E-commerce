...
export default async function RegisterSuccess() {
  ...
  return (
    <div className="flex flex-col h-fill justify-center items-center space-y-4 px-4 text-center pb-20">
      ...
      <div>
        <h1 className="lg:text-heading-w-1 text-heading-m-1 font-bold">
          Thank You!
        </h1>
      </div>
